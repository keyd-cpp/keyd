...
extern constexpr std::array<keycode_table_ent, KEYD_ENTRY_COUNT> keycode_table = []() {
	...
	r[84] = { "iso-level3-shift", "level3", NULL },
	r[KEY_A] = { "a", NULL, "A" },
	r[KEY_S] = { "s", NULL, "S" },
	r[KEY_D] = { "d", NULL, "D" },
	r[KEY_F] = { "f", NULL, "F" },
	...
	r[KEY_COMPOSE] = { "key_compose", NULL, NULL },
	...
	r[KEY_COFFEE] = { "screenlock", "coffee" },
	r[KEY_ROTATE_DISPLAY] = { "rotate_display", "direction" },
	...
	r[KEY_DASHBOARD] = { "dashboard", "all_applications" },
	...
	r[KEY_VIDEO_NEXT] = { "videonext", "next" },
	r[KEY_VIDEO_PREV] = { "videoprev", "prev" },
	r[KEY_BRIGHTNESS_CYCLE] = { "brightness_cycle", "cycle" },
	r[KEY_BRIGHTNESS_AUTO] = { "brightness_auto", "brightness_zero" },
	r[KEY_DISPLAY_OFF] = { "display_off", "off" },
	r[KEY_WWAN] = { "wwan", "wimax" },
	r[KEY_RFKILL] = { "rfkill" },
	r[KEY_MICMUTE] = { "micmute" },
	// BTN_MISC start
	r[BTN_0] = { "btn0" },
	r[BTN_1] = { "btn1" },
	r[BTN_2] = { "btn2" },
	...
	r[BTN_9] = { "btn9" },
	// BTN_MOUSE start
	r[BTN_LEFT] = { "leftmouse", },
	r[BTN_RIGHT] = { "rightmouse", },
	r[BTN_MIDDLE] = { "middlemouse", },
	r[BTN_SIDE] = { "mouse1", "mouseside" },
	r[BTN_EXTRA] = { "mouse2", "mouseextra" },
	r[BTN_FORWARD] = { "mouseforward", },
	r[BTN_BACK] = { "mouseback", },
	r[BTN_TASK] = { "mousetask", },
	//
	r[KEY_FN] = { "fn" },
	r[KEY_ZOOM] = { "zoom" },
	r[KEY_VOICECOMMAND] = { "voicecommand" },
